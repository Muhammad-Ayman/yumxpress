...
import yumxpress.pojo.StaffPojo;
    ...
    public class Mailer{
        ...
        static {
//        final String username="19shivangi.sharma80@gmail.com";
//        final String password="mrlb mtzi cuzr cfxm";
        ...
        Message message = new MimeMessage(session);
             message.setRecipients(
              ...
              String emailBody = "Dear " + customer.getCustomerName() + ",\n"
                ...
                + "\n"
                + "We are happy to have you as our esteemed customer.Please find your account information below : \n"
                + "\n"
